...
<div class="space-y-6">
    <h2 class="text-xl font-extrabold text-zinc-950 uppercase tracking-tight">Freight Quote Requests</h2>

    <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm p-6">
        @if($quotes->count() > 0)
