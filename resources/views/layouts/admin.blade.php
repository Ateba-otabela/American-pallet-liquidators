    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed md:static inset-y-0 left-0 z-40 w-64 bg-zinc-950 text-zinc-400 flex flex-col justify-between transition-transform duration-300 md:translate-x-0 flex-shrink-0 shadow-xl border-r border-zinc-900">
        ...
        <div>
            ...
            <nav class="p-4 space-y-1.5 text-sm font-semibold">
                ...
                <a href="{{ route('admin.support.index') }}" class="flex items-center gap-3 px-4 py-3 rounded transition-colors duration-150
                    {{ request()->routeIs('admin.support*') ? 'bg-zinc-900 text-white' : 'hover:bg-zinc-900 hover:text-white' }}">
                ...
                <a href="{{ route('admin.subscribers') }}" class="flex items-center gap-3 px-4 py-3 rounded transition-colors duration-150
